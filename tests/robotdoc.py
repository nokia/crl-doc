...
import six
from crl.doc.robotdocsconfs import RobotdocsconfBase
...
class NameRobotdocsconfBase(object):
...
class RobotDoc(object):
    ...
    @property
    def rootpath(self):
        return set([os.path.join(*r) for r in self._rootpaths])
